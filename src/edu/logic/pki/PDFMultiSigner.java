 ...
 */
public class PDFMultiSigner implements SignerInterface{
    ...
    public File sign(File fileToSign, File outputFile, PrivateKey keyToSign, Certificate certificate) {
        ...
        try {
            ...
            int curretnsignature = getCurrentSinature(fileToSign);
            ...
            appearance.setVisibleSignature(new Rectangle(0, 0, 0, 0), 1, "signature"+curretnsignature);
            ...
            Logger.getLogger(PDFMultiSigner.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public File sign(File fileToSign, PrivateKey keyToSign, Certificate certificate) {
        ...
        return sign(fileToSign, new File(name+"_multisigned."+ext), keyToSign, certificate);
    }
    
    private int getCurrentSinature(File PDFtoSign){
        
        return 0;
    }
    
    private boolean addSignatureFieds(){
